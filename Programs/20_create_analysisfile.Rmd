...
combined_data <- full_join(tract_boundaries, dedup_tracts_nhoods, by = "geoid") %>%
  full_join(., parks_stats, by = "geoid") %>%
  full_join(., library_stats, by = "geoid") %>%
  full_join(., grocery_stats, by = "geoid")
